    ...
    <main>
        ...
        <form method="POST" class="register">
            <div class="infoRegister">
                ...
                <div class="nameBox">
                    <input value="<?= !empty($_POST['id_subcategory']) ? $_POST['id_subcategory'] : '' ?>" class="inputName" type="text" name="id_subcategory" id="id_subcategory" placeholder="Categorie article" required />
